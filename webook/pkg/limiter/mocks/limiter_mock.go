...
// Source: ./webook/pkg/limiter/wechat.go
//
// Generated by this command:
//
//	mockgen -source=./webook/pkg/limiter/wechat.go -destination=./webook/pkg/limiter/mocks/limiter_mock.go -package=limitermocks
//
