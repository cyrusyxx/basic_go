...
// Source: ./webook/internal/service.go/sms/types.go
//
// Generated by this command:
//
//	mockgen -source=./webook/internal/service.go/sms/types.go -package=smsmocks -destination=./webook/internal/service.go/sms/mocks/sms_mock.go
//
