...
// Source: ./webook/internal/service/interactive.go
//
// Generated by this command:
//
//	mockgen -source=./webook/internal/service/interactive.go -package=svcmocks -destination=./webook/internal/service/mocks/interactive_mock.go
//
...
func (m *MockInteractiveService) Get(ctx context.Context, biz string, id, uid int64) (domain.InteractiveCount, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, biz, id, uid)
	ret0, _ := ret[0].(domain.InteractiveCount)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInteractiveService) GetByIds(ctx context.Context, biz string, ids []int64) (map[int64]domain.InteractiveCount, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByIds", ctx, biz, ids)
	ret0, _ := ret[0].(map[int64]domain.InteractiveCount)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// IncreaseViewCount mocks base method.
func (m *MockInteractiveService) IncreaseViewCount(ctx context.Context, biz string, bizId int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IncreaseViewCount", ctx, biz, bizId)
	ret0, _ := ret[0].(error)
	return ret0
}

// IncreaseViewCount indicates an expected call of IncreaseViewCount.
func (mr *MockInteractiveServiceMockRecorder) IncreaseViewCount(ctx, biz, bizId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncreaseViewCount", reflect.TypeOf((*MockInteractiveService)(nil).IncreaseViewCount), ctx, biz, bizId)
}
