...
func (m *MockArticleService) GetByAuthor(ctx context.Context, uid, offset, limit int64) ([]domain.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleService) GetPubById(ctx context.Context, uid, id int64) (domain.Article, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleServiceMockRecorder) GetPubById(ctx, uid, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPubById", reflect.TypeOf((*MockArticleService)(nil).GetPubById), ctx, uid, id)
}

// ListPub mocks base method.
func (m *MockArticleService) ListPub(ctx context.Context, start time.Time, offset, limit int64) ([]domain.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleService) Publish(ctx context.Context, arti domain.Article) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Publish", ctx, arti)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockArticleServiceMockRecorder) Publish(ctx, arti any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockArticleService)(nil).Publish), ctx, arti)
}

// Save mocks base method.
func (m *MockArticleService) Save(ctx context.Context, arti domain.Article) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", ctx, arti)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockArticleServiceMockRecorder) Save(ctx, arti any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockArticleService)(nil).Save), ctx, arti)
}
